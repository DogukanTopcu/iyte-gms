...
interface DeptSecretariatInfoCardProps {
  name: string;
  email: string;
  department: Department;
}

export default function DeptSecretariatInfoCard({ name, email, department }: DeptSecretariatInfoCardProps) {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mb-8">
      <h2 className="text-xl font-medium text-gray-700 mb-4">Department Secretariat Information</h2>
