...
const DeptSecretariatSidebar = ({ activePage }: { activePage: string }) => {
  return (
    ...
    <ul className="space-y-1">
      ...
      <li>
        <Link 
          href="/dept-secretariat/student-list" 
          className={`flex items-center px-4 py-3 rounded-lg hover:bg-red-700 transition-colors ${
      ...
      <li>
        <Link 
          href="/dept-secretariat/top-three-students" 
          className={`flex items-center px-4 py-3 rounded-lg hover:bg-red-700 transition-colors ${
...
export default DeptSecretariatSidebar