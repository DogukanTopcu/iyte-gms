...
export async function POST() {
    try {
        ...
        return NextResponse.json({ message: 'Advisors created successfully' }, 
            {
                status: 200,
                headers: {
                    'Content-Type': 'application/json',
        ...
        return NextResponse.json({ error: 'Failed to create advisors' }, 
        { 
            status: 500,
            headers: {
                'Content-Type': 'application/json',
...
export async function GET() {
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch advisors' },
             { 
                status: 500,
                headers: {
                    'Content-Type': 'application/json',
